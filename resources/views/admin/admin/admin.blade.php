                   ...
                   @foreach ($emp as $key => $data)
                    <tbody>
                      <tr>
                       ...
                       <td></td>
<td>
    <a href="{{ url('admin/delete/'.$data->id) }}"><i class="fa fa-close"></i>&nbsp;&nbsp;Delete</a>
</td>
<td>
    <a href="{{ url('admin/edit/'.$data->id) }}"><i class="fa fa-edit"></i>&nbsp;&nbsp;Edit</a>
</td>
<td>
    <a href="{{ url('admin/detail/'.$data->id) }}"><i class="fa fa-list"></i>&nbsp;&nbsp;Detail</a>
</td>
                     </tr>
                    </tbody>
                    @endforeach

                    ...
                    <div class="item active"  style="background-image: url('img/slider/bg2.jpg')" >
                        <div class="carousel-caption">
                            <div class="animated bounceInRight">
                                <h2>HELLO!<br>WE ARE SMART EMPLOYEES.</h2>
                                <p>Kami akan membantu anda dalam menghitung semua yang berhubungan dengan gaji ataupun uang makan anda</p>
                            </div>
                        </div>
                    </div>              
                    ...
                    <div class="item" style="background-image: url('img/slider/bg2.jpg')">                
                        <div class="carousel-caption">
                            <div class="animated bounceInDown">
                                <h2>HELLO!<br>WE ARE SMART EMPLOYEES.</h2>
                                <p>Anda ingin melihat masa depan yang cerah ? bekerjalah dengan baik dan jujur</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item" style="background-image: url('img/slider/bg3.jpg')">                 
                         <div class="carousel-caption">
                            <div class="animated bounceInUp">
                                <h2>HELLO!<br>WE ARE SMART EMPLOYEES.</h2>
                                <p>kami akan membantu anda dalam melihat absen jika anda tidak masuk / sakit</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center wow fadeInDown">
                            <h2>Services</h2>    
                            <p>Smart Employees very helpful employees to more easily do the job.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row wow zoomIn">
                    <div class="col-lg-12">
                        <div class="call-to-action text-center">
                            <p>“JANGAN SIA SIAKAN WAKTU ANDA HANYA DENGAN BERMAIN MAIN! HIDUP DI DUNIA HANYA SEKALI!”</p>
                            <span>John Doe</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 wow fadeInUp">
                        <div class="special-plan text-center">
                            <p></p>
                            <a href="/login" class="btn btn-blue">Join Now!</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="copyright">
                            ...
                            <p>Theme by <a href="http://graphberry.com">GraphBerry.com</a> Developed by <a target="_blank" href="http://facebook.com/wahidweki12345">Yusuf Mawahid</a></p>
                        </div>
